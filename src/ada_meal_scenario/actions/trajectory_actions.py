...
class RunTrajectory(ActionSequence):
    _TRAJ_PATH = None
    __CACHED_TRAJ__ = {}
    def __init__(self, file_base, prev_result=None, config=None):
...
LookAtPlate = partial(RunTrajectory, 'traj_lookingAtPlate.xml')
Serve = partial(RunTrajectory, 'traj_serving.xml')
